...
$mysqli = login_db_connect() or die ("Cannot connect to 1&1.");
  ...
  <body >
    ...
    <div class="container">
     ...
     <h2><span style="color:Black ">Cookie Crumbs</span></h2>
      <div class="jumbotron">
        <h1 class="header">ATM Paid-Out</h1>
	...
	<!-- PUll values for time and date -->
        ...
        if ( $insert_stmt = $mysqli->prepare(
									 "SELECT atm_paid_out_number FROM atm_paid_outs
									  ORDER BY atm_paid_out_number DESC
									  LIMIT 1" ) )
           ...
           $insert_stmt->execute();
			  ...
			  $insert_stmt->bind_result( $next_atm_paid_out);
			  $insert_stmt->fetch();
		...
		<div>
	<form class="form-horizontal" role="form" action="../inserts/insert_atm_paid_out.php" method='post'>
	...
	<input type="hidden" id="stacker_number" name="atm_paid_out_number" value="" >

		  <div class="form-group">
   		 <label for="stacker_number_show" class="col-sm-5 control-label">ATM Paid-Out Number</label>
   	 <div class="col-sm-3">
   	   <input type="text" class="form-control" id="stacker_number_show" name="stacker_number_show" disabled value="<?php echo $next_atm_paid_out + 1;?>">
   	 </div>


 		 </div><hr>
		  <div class="form-group">
   		 <label for="user_show" class="col-xs-5 control-label">Badge</label>
   	 <div class="col-xs-3">
...
<div class="form-group">
			  ...
			  <div class="form-group">
  			  <label for="gross_atm_amount" class="col-sm-5 control-label">Gross ATM Amount </label>
			    <div class="col-sm-3">
   				   <input type="text" class="form-control" id="gross_atm_amount" name="gross_atm_amount" placeholder="Before Reversals" >
   			 </div>
		  </div><hr>

		  <div class="form-group">
  			  <label for="reversals" class="col-sm-5 control-label">Reversals</label>
			    <div class="col-sm-3">
   				   <input type="text" class="form-control" id="reversals" name="reversals" placeholder="" >
   			 </div>
		  </div><hr>
			  <div class="form-group">
  			  <label for="net_atm_amount" class="col-sm-5 control-label">Net ATM Amount </label>
			    <div class="col-sm-3">
   				   <input type="text" class="form-control" id="net_atm_amount" name="net_atm_amount" placeholder="After Reversals" >
   			 </div>
		  </div><hr>
