...
function setupTablesorter( role )
{
	...
	$('#table_panel_head').html( '<div class="col-xs-1"><button id="optionsBtn" class="btn btn-info collapse in" data-toggle="collapse"  href="#filter_panel"><i class="fa fa-search"></i>&nbsp;Options</button></div><div class="col-xs-3"><input class="form-control search" type="text" placeholder="Filter Results" data-column="all"></div><div class="col-xs-8"><button id="createReportBtn" class="pull-right btn btn-info collapse in" data-toggle="collapse" href="#report_panel"><i class="fa fa-file"></i>&nbsp;&nbsp;Create Report</button></div>' );
	...
	$( '#optionsBtn' ).on( 'click', function(){
		$( '#report_panel:visible, #search_panel:visible' ).collapse( 'hide' );
	});

	$( '#createReportBtn' ).on( 'click', function(){
		$( '#search_panel:visible, #filter_panel:visible' ).collapse( 'hide' );
	});

	$( '#searchBtn' ).on( 'click', function(){
		$( '#report_panel:visible, #filter_panel:visible' ).collapse( 'hide' );
	});
