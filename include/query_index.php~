...
// Retrieve network info based on tag number
$get_network_from_tag = "SELECT n.mac,
																n.wmac,
																n.ip
...
// Retrieve purchase info based on tag number
$get_purchase_from_tag = "SELECT 	p.purchase_order,
																	p.purchase_date,
																	p.purchased_by
